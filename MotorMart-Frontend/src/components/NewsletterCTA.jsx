  ...
  return (
    <section className="py-10">
      <div className="max-w-6xl mx-auto px-4">
        <div className="relative overflow-hidden rounded-xl bg-secondary text-secondary-foreground p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <img src="assets/1.jpg" alt="Car" className="w-full h-40 md:h-48 object-cover rounded-lg shadow" />
          </div>
        </div>
      </div>
    </section>
